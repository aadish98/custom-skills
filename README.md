...
Writes and edits documentation, slide copy, PDF content, README files, papers, and UI copy. It rests on three sources, consulted in order:

1. **[Orwell's six rules](https://www.orwellfoundation.com/the-orwell-foundation/orwell/essays-and-other-works/politics-and-the-english-language/)**, from "Politics and the English Language," govern words and phrases: cut what you can, choose the short word, prefer the active, and break any rule rather than write something barbarous.
2. **[Google's developer documentation style guide](https://developers.google.com/style)**, adapted for scientific communication, sets voice and conventions: second person, active voice, sentence case, and no filler. The adaptation keeps precise technical terms that a plainer word would blur.
3. **[Gopen and Swan's "The Science of Scientific Writing"](https://www.cs.tufts.edu/comp/105-2015s/readings/sci.html)** supplies the structure that readers expect: subjects beside their verbs, old information opening a sentence, and the new, emphasized information at its end.
...
For example, to install the technical-writing skill for Cursor:
